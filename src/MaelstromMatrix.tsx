		...
		>
			...
			>
				...
				<a
					...
					className="flex items-center gap-2 font-mono uppercase tracking-wider text-slate-400 hover:text-[#00f3ff] transition-all duration-200 group border-r border-slate-800 pr-4"
					title="View Go Distributed Systems Engine"
				>
					{/* Custom Simple Icons GitHub SVG */}
					<svg
						role="img"
						viewBox="0 0 24 24"
